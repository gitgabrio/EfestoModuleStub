...
public class ClientCompiledConsumer {

    private static final Logger logger = LoggerFactory.getLogger(ClientCompiledConsumer.class);

    private ClientCompiledConsumer() {
    }

    public static void startCompiledConsumer() throws InterruptedException {
    ...
    static void consumeModel(ConsumerRecord<Long, JsonNode> toConsume) {
        ...
        try {
            ModelLocalUriId retrieved = getModelLocalUriId(toConsume.value());
    ...
    private static Consumer<Long, JsonNode> createConsumer() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG,
                  ClientCompiledConsumer.class.getSimpleName());
        ...
        consumer.subscribe(Collections.singletonList(COMPILED_TOPIC));
        return consumer;
    }
}
